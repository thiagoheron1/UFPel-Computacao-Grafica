...
class Main {
  ...
  drawAllObjects() {
    ...
    for (let index = 0; index < this.object.length; index++) {
      ...
      this.object[index].matrix = this.object[index].m4.xRotate(this.object[index].matrix, this.object[index].rotation[0]);
      this.object[index].matrix = this.object[index].m4.yRotate(this.object[index].matrix, this.object[index].rotation[1]);
